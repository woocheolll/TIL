...
```python
for i in Movie.objects.all().order_by('-opening_date'):
    print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
```python
i = Movie.objects.all().order_by('opening_date')[0]
print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
```python
bjh_id = Director.objects.get(name='봉준호').id

for i in Movie.objects.filter(director=bjh_id).order_by('opening_date'):
    print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
i = Movie.objects.filter(director=bjh_id).order_by('opening_date')[1]
print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
for i in Movie.objects.filter(opening_date__gt=day).order_by('opening_date'):
    print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
for i in Movie.objects.filter(director=bjh_id, genre=drama_id).order_by('opening_date'):
    print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
for i in Movie.objects.exclude(director=bjh_id).order_by('opening_date'):
    print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```